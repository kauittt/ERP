...
import { Row, Collapse, OverlayTrigger, Tooltip } from "react-bootstrap";
            ...
            <div>
                ...
                <Collapse in={collapse}>
                    <CollapseContent>
                        <TitleWrap>
                            <p>
                                This customizer allows you to see the different
                                variations of the data table.
                            </p>
                        </TitleWrap>
                        <CollapseItem>
                        ...
                        {fullCustomizer && (
                            <CollapseItem>
                                {arrayTableCustomizerAddictionToggle.map(
                                    (item) => {
                                        const toggle = (
                                            <div
                                                key={item.id}
